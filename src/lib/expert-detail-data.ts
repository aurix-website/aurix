...
export const EXPERT_DETAILS: Record<string, ExpertDetail> = {
  'kaan-yazici': {
    ...
    relatedServices: [
      ...
      { label: 'Takım Koçluğu', href: '/hizmetler/kurumsal-egitim' },
  ...
  'hulya-aksu-spizuoco': {
    ...
    relatedServices: [
      { label: 'Yönetici Koçluğu', href: '/hizmetler/yonetici-koclugu' },
      { label: 'Kariyer Koçluğu', href: '/hizmetler/bireysel-kocluk' },
      { label: 'Global Uyum ve Kariyer Koçluğu', href: '/hizmetler/ogrenci-koclugu' },
      { label: 'Kurumsal Eğitimler', href: '/hizmetler/kurumsal-egitim' },
    ],
    primaryCtaLabel: 'Hülya Aksu Spizuoco ile Ön Görüşme Talep Et',
    secondaryCta: { label: 'Global Kariyer Desteğini İncele', href: '/hizmetler/ogrenci-koclugu' },
  ...
  'secil-ozbayir': {
    ...
    secondaryCta: { label: 'Kariyer Koçluğunu İncele', href: '/hizmetler/bireysel-kocluk' },

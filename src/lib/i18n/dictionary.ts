...
export const dictionary = {
  tr: {
    ...
    footer: {
      ...
      footerNavAria: 'Alt bilgi navigasyonu',
      aboutHeading: 'AURIX',
      servicesHeading: 'Hizmetler',
      viewAllServices: 'Tüm Hizmetleri Gör',
      startHeading: 'Başlayın',
      ctaExpertMatch: 'Size Uygun Danışmanı Bulalım',
      ctaCorporate: 'Kurumsal İhtiyaç Analizi',
    ...
    hero: {
      ...
      body: 'AURIX; bireysel gelişim, yönetici koçluğu, kurumsal eğitim ve öğrenci koçluğu alanlarında uzman kadrosuyla yapılandırılmış gelişim süreçleri sunar.',
      ...
      stats: [
        { text: 'Ege Üniversitesi Teknopark', logo: '/media/ege-universitesi-teknopark-logo.png', label: 'Konum' },
        { value: 8, suffix: '', label: 'Uzman', duration: 800 },
        { value: 100, suffix: '%', label: 'Alanında Uzman', duration: 1400 },
      ],
    },
    manifesto: {
  ...
  en: {
    ...
    footer: {
      ...
      ctaExpertMatch: 'Find the Right Consultant for You',
      ctaCorporate: 'Corporate Needs Analysis',
    ...
    hero: {
      ...
      body: 'AURIX offers structured development processes with an expert team across personal growth, executive coaching, corporate training, and student coaching.',
      ...
      stats: [
        { text: 'Ege University Technopark', logo: '/media/ege-universitesi-teknopark-logo.png', label: 'Location' },
        { value: 8, suffix: '', label: 'Experts', duration: 800 },
        { value: 100, suffix: '%', label: 'Field Experts', duration: 1400 },
      ],
    },
    manifesto: {

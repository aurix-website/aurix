...
const detail = SERVICE_DETAILS['kariyer-koclugu']
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      languages: { tr: '/hizmetler/kariyer-koclugu', en: '/en/hizmetler/kariyer-koclugu' },
    },
  }
}

export default async function KariyerKoclugu({
  params,
}: {
  params: Promise<{ locale: Locale }>
}) {

...
const Leads: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'interestArea', type: 'select', required: true, options: [
      ...
      { label: 'Liderlik ve Yönetici Koçluğu', value: 'yonetici-koclugu' },
      { label: 'Takım Koçluğu', value: 'takim-koclugu' },
      { label: 'Kurumsal Eğitimler', value: 'kurumsal-egitim' },
      { label: 'Öğrenci Mentörlüğü ve Sınav Stratejisi', value: 'ogrenci-mentorlugu-sinav-stratejisi' },
      { label: 'Öğrenci Koçluğu', value: 'ogrenci-koclugu' },
      { label: 'Gençler için Kariyer Farkındalığı', value: 'genclerde-kariyer-farkindaligi' },
      { label: 'Küresel Uyum ve Kariyer Koçluğu', value: 'global-uyum-kariyer-koclugu' },
      { label: 'Dil Öğreniminde Zihinsel Dönüşüm Koçluğu', value: 'dil-ogreniminde-zihinsel-donusum-koclugu' },
